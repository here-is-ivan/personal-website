...
const GetInTouchScreen = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className='relative w-dvw h-dvh flex justify-center items-center text-white bg-black'
      onMouseMove={handleMouseMove}
    >
      <div
        className='absolute opacity-30 inset-0 h-full w-full bg-[linear-gradient(to_right,#22c55e_1px,transparent_1px),linear-gradient(to_bottom,#22c55e_1px,transparent_1px)] bg-[size:4rem_4rem]'
        style={{
      ...
      <div className='flex flex-col items-center z-10'>
        ...
        <ul className='flex flex-col gap-4 mb-6 text-lg'>
          <li>
            <a
              ...
              target='_blank'
              className='flex items-center justify-center gap-2 hover:text-green-500 duration-300'
            >
              <FaGithub />
              <h3>GitHub</h3>
            </a>
        ...
        <a
          ...
          className='flex items-center justify-center border gap-3 rounded-3xl px-4 py-2 cursor-pointer bg-black group hover:bg-white hover:text-black duration-300'
        >
